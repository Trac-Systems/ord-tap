  ...
  pub fn run(self, settings: Settings, index: Arc<Index>, handle: Handle) -> SubcommandResult {
    Runtime::new()?.block_on(async {
      ...
      let router = router
        ...
        // TAP bitmap endpoints
        .route("/r/tap/getBitmap/{bitmap_block}", get(r::tap_get_bitmap))
        .route(
          "/r/tap/getBitmapByInscription/{inscription}",
          get(r::tap_get_bitmap_by_inscription),
        )
        .route(
          "/r/tap/getBitmapWalletHistoricListLength/{address}",
          get(r::tap_get_bitmap_wallet_historic_list_length),
        )
        .route(
          "/r/tap/getBitmapWalletHistoricList/{address}",
          get(r::tap_get_bitmap_wallet_historic_list),
        )
        .route(
          "/r/tap/getBitmapEventByBlockLength/{block}",
          get(r::tap_get_bitmap_event_by_block_length),
        )
        .route(
          "/r/tap/getBitmapEventByBlock/{block}",
          get(r::tap_get_bitmap_event_by_block),
        )
        // TAP deployment endpoints
        .route("/r/tap/getDeploymentsLength", get(r::tap_get_deployments_length))
        .route("/r/tap/getDeployments", get(r::tap_get_deployments))
        .route("/r/tap/getDeployment/{ticker}", get(r::tap_get_deployment))
        .route(
          "/r/tap/getMintTokensLeft/{ticker}",
          get(r::tap_get_mint_tokens_left),
        )
        .route(
          "/r/tap/getDeployedListLength/{tx}",
          get(r::tap_get_deployed_list_length),
        )
        .route(
          "/r/tap/getDeployedList/{tx}",
          get(r::tap_get_deployed_list),
        )
        .route(
          "/r/tap/getTickerDeployedListLength/{ticker}/{tx}",
          get(r::tap_get_ticker_deployed_list_length),
        )
        .route(
          "/r/tap/getTickerDeployedList/{ticker}/{tx}",
          get(r::tap_get_ticker_deployed_list),
        )
        .route(
          "/r/tap/getDeployedListByBlockLength/{block}",
          get(r::tap_get_deployed_list_by_block_length),
        )
        .route(
          "/r/tap/getDeployedListByBlock/{block}",
          get(r::tap_get_deployed_list_by_block),
        )
        .route(
          "/r/tap/getTickerDeployedListByBlockLength/{ticker}/{block}",
          get(r::tap_get_ticker_deployed_list_by_block_length),
        )
        .route(
          "/r/tap/getTickerDeployedListByBlock/{ticker}/{block}",
          get(r::tap_get_ticker_deployed_list_by_block),
        )
        // TAP mint endpoints
        .route(
          "/r/tap/getAccountMintListLength/{address}/{ticker}",
          get(r::tap_get_account_mint_list_length),
        )
        .route(
          "/r/tap/getAccountMintList/{address}/{ticker}",
          get(r::tap_get_account_mint_list),
        )
        .route(
          "/r/tap/getTickerMintListLength/{ticker}",
          get(r::tap_get_ticker_mint_list_length),
        )
        .route(
          "/r/tap/getTickerMintList/{ticker}",
          get(r::tap_get_ticker_mint_list),
        )
        .route(
          "/r/tap/getMintListLength",
          get(r::tap_get_mint_list_length),
        )
        .route(
          "/r/tap/getMintList",
          get(r::tap_get_mint_list),
        )
        .route(
          "/r/tap/getMintedListLength/{tx}",
          get(r::tap_get_minted_list_length),
        )
        .route(
          "/r/tap/getMintedList/{tx}",
          get(r::tap_get_minted_list),
        )
        .route(
          "/r/tap/getTickerMintedListLength/{ticker}/{tx}",
          get(r::tap_get_ticker_minted_list_length),
        )
        .route(
          "/r/tap/getAccumulator/{inscription}",
          get(r::tap_get_accumulator),
        )
        .route(
          "/r/tap/getAccountAccumulatorListLength/{address}",
          get(r::tap_get_account_accumulator_list_length),
        )
        .route(
          "/r/tap/getAccountAccumulatorList/{address}",
          get(r::tap_get_account_accumulator_list),
        )
        .route(
          "/r/tap/getAccumulatorListLength",
          get(r::tap_get_accumulator_list_length),
        )
        .route(
          "/r/tap/getAccumulatorList",
          get(r::tap_get_accumulator_list),
        )
        .route(
          "/r/tap/getTrade/{inscription_id}",
          get(r::tap_get_trade),
        )
        .route(
          "/r/tap/getAccountTradesListLength/{address}/{ticker}",
          get(r::tap_get_account_trades_list_length),
        )
        .route(
          "/r/tap/getAccountTradesList/{address}/{ticker}",
          get(r::tap_get_account_trades_list),
        )
        .route(
          "/r/tap/getTickerTradesListLength/{ticker}",
          get(r::tap_get_ticker_trades_list_length),
        )
        .route(
          "/r/tap/getTickerTradesList/{ticker}",
          get(r::tap_get_ticker_trades_list),
        )
        .route(
          "/r/tap/getTradesListLength",
          get(r::tap_get_trades_list_length),
        )
        .route(
          "/r/tap/getTradesList",
          get(r::tap_get_trades_list),
        )
        .route(
          "/r/tap/getAccountReceiveTradesFilledListLength/{address}/{ticker}",
          get(r::tap_get_account_receive_trades_filled_list_length),
        )
        .route(
          "/r/tap/getAccountReceiveTradesFilledList/{address}/{ticker}",
          get(r::tap_get_account_receive_trades_filled_list),
        )
        .route(
          "/r/tap/getAccountTradesFilledListLength/{address}/{ticker}",
          get(r::tap_get_account_trades_filled_list_length),
        )
        .route(
          "/r/tap/getAccountTradesFilledList/{address}/{ticker}",
          get(r::tap_get_account_trades_filled_list),
        )
        .route(
          "/r/tap/getTickerTradesFilledListLength/{ticker}",
          get(r::tap_get_ticker_trades_filled_list_length),
        )
        .route(
          "/r/tap/getTickerTradesFilledList/{ticker}",
          get(r::tap_get_ticker_trades_filled_list),
        )
        .route(
          "/r/tap/getTradesFilledListLength",
          get(r::tap_get_trades_filled_list_length),
        )
        .route(
          "/r/tap/getTradesFilledList",
          get(r::tap_get_trades_filled_list),
        )
        // TAP token-auth endpoints
        .route(
          "/r/tap/getAuthCancelled/{inscription_id}",
          get(r::tap_get_auth_cancelled),
        )
        .route(
          "/r/tap/getAuthHashExists/{hash}",
          get(r::tap_get_auth_hash_exists),
        )
        .route(
          "/r/tap/getAuthCompactHexExists/{hash}",
          get(r::tap_get_auth_compact_hex_exists),
        )
        .route(
          "/r/tap/getAuthListLength",
          get(r::tap_get_auth_list_length),
        )
        .route(
          "/r/tap/getAuthList",
          get(r::tap_get_auth_list),
        )
        .route(
          "/r/tap/getAccountAuthListLength/{address}",
          get(r::tap_get_account_auth_list_length),
        )
        .route(
          "/r/tap/getAccountAuthList/{address}",
          get(r::tap_get_account_auth_list),
        )
        .route(
          "/r/tap/getRedeemListLength",
          get(r::tap_get_redeem_list_length),
        )
        .route(
          "/r/tap/getRedeemList",
          get(r::tap_get_redeem_list),
        )
        .route(
          "/r/tap/getAccountRedeemListLength/{address}",
          get(r::tap_get_account_redeem_list_length),
        )
        .route(
        ...
        .route(
          ...
          get(r::tap_get_privilege_auth_cancelled),
        )
        .route(
          "/r/tap/getPrivilegeAuthHashExists/{hash}",
          get(r::tap_get_privilege_auth_hash_exists),
        )
        .route(
          "/r/tap/getPrivilegeAuthCompactHexExists/{hash}",
          get(r::tap_get_privilege_auth_compact_hex_exists),
        )
        .route(
          "/r/tap/getPrivilegeAuthListLength",
          get(r::tap_get_privilege_auth_list_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthList",
          get(r::tap_get_privilege_auth_list),
        )
        .route(
          "/r/tap/getAccountPrivilegeAuthListLength/{address}",
          get(r::tap_get_account_privilege_auth_list_length),
        )
        .route(
          "/r/tap/getAccountPrivilegeAuthList/{address}",
          get(r::tap_get_account_privilege_auth_list),
        )
        // DMT element + events endpoints
        .route(
          "/r/tap/getDmtElementsListLength",
          get(r::tap_get_dmt_elements_list_length),
        )
        .route(
          "/r/tap/getDmtElementsList",
          get(r::tap_get_dmt_elements_list),
        )
        .route(
          "/r/tap/getDmtEventByBlockLength/{block}",
          get(r::tap_get_dmt_event_by_block_length),
        )
        .route(
          "/r/tap/getDmtEventByBlock/{block}",
          get(r::tap_get_dmt_event_by_block),
        )
        .route(
          "/r/tap/getDmtMintHoldersHistoryListLength/{inscription}",
          get(r::tap_get_dmt_mint_holders_history_list_length),
        )
        .route(
          "/r/tap/getDmtMintHoldersHistoryList/{inscription}",
          get(r::tap_get_dmt_mint_holders_history_list),
        )
        .route(
          "/r/tap/getDmtMintHolder/{inscription}",
          get(r::tap_get_dmt_mint_holder),
        )
        .route(
          "/r/tap/getDmtMintHolderByBlock/{ticker}/{block}",
          get(r::tap_get_dmt_mint_holder_by_block),
        )
        .route(
          "/r/tap/getDmtMintWalletHistoricListLength/{address}",
          get(r::tap_get_dmt_mint_wallet_historic_list_length),
        )
        .route(
          "/r/tap/getDmtMintWalletHistoricList/{address}",
          get(r::tap_get_dmt_mint_wallet_historic_list),
        )
        .route(
          "/r/tap/getAccountBlockedTransferables/{address}",
          get(r::tap_get_account_blocked_transferables),
        )
        // TAP privilege verification endpoints
        .route(
          "/r/tap/getPrivilegeAuthorityVerifiedInscription/{privilege_inscription_id}/{collection_name}/{verified_hash}/{sequence}",
          get(r::tap_get_privilege_authority_verified_inscription),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityVerifiedByInscription/{verified_inscription_id}",
          get(r::tap_get_privilege_authority_verified_by_inscription),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityIsVerified/{privilege_inscription_id}/{collection_name}/{verified_hash}/{sequence}",
          get(r::tap_get_privilege_authority_is_verified),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityListLength/{privilege_inscription_id}",
          get(r::tap_get_privilege_authority_list_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityList/{privilege_inscription_id}",
          get(r::tap_get_privilege_authority_list),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityCollectionListLength/{privilege_inscription_id}/{collection_name}",
          get(r::tap_get_privilege_authority_collection_list_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityCollectionList/{privilege_inscription_id}/{collection_name}",
          get(r::tap_get_privilege_authority_collection_list),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByPrivBlockLength/{privilege_authority_inscription_id}/{block}",
          get(r::tap_get_privilege_authority_event_by_priv_block_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByPrivBlock/{privilege_authority_inscription_id}/{block}",
          get(r::tap_get_privilege_authority_event_by_priv_block),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByBlockLength/{block}",
          get(r::tap_get_privilege_authority_event_by_block_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByBlock/{block}",
          get(r::tap_get_privilege_authority_event_by_block),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByPrivColBlockLength/{privilege_authority_inscription_id}/{collection_name}/{block}",
          get(r::tap_get_privilege_authority_event_by_priv_col_block_length),
        )
        .route(
          "/r/tap/getPrivilegeAuthorityEventByPrivColBlock/{privilege_authority_inscription_id}/{collection_name}/{block}",
          get(r::tap_get_privilege_authority_event_by_priv_col_block),
        )
        .route(
          "/r/tap/getTickerMintedList/{ticker}/{tx}",
          get(r::tap_get_ticker_minted_list),
        )
        .route(
          "/r/tap/getMintedListByBlockLength/{block}",
          get(r::tap_get_minted_list_by_block_length),
        )
        .route(
          "/r/tap/getMintedListByBlock/{block}",
          get(r::tap_get_minted_list_by_block),
        )
        .route(
          "/r/tap/getTickerMintedListByBlockLength/{ticker}/{block}",
          get(r::tap_get_ticker_minted_list_by_block_length),
        )
        .route(
          "/r/tap/getTickerMintedListByBlock/{ticker}/{block}",
          get(r::tap_get_ticker_minted_list_by_block),
        )
        // TAP balances and holders
        .route(
          "/r/tap/getBalance/{address}/{ticker}",
          get(r::tap_get_balance),
        )
        .route(
          "/r/tap/getTransferable/{address}/{ticker}",
          get(r::tap_get_transferable),
        )
        .route(
          "/r/tap/getSingleTransferable/{inscription}",
          get(r::tap_get_single_transferable),
        )
        .route(
          "/r/tap/getHoldersLength/{ticker}",
          get(r::tap_get_holders_length),
        )
        .route(
          "/r/tap/getHistoricHoldersLength/{ticker}",
          get(r::tap_get_historic_holders_length),
        )
        .route(
          "/r/tap/getHolders/{ticker}",
          get(r::tap_get_holders),
        )
        .route(
          "/r/tap/getHistoricHolders/{ticker}",
          get(r::tap_get_historic_holders),
        )
        // Account tokens summary
        .route(
          "/r/tap/getAccountTokensLength/{address}",
          get(r::tap_get_account_tokens_length),
        )
        .route(
          "/r/tap/getAccountTokens/{address}",
          get(r::tap_get_account_tokens),
        )
        .route(
          "/r/tap/getAccountTokensBalance/{address}",
          get(r::tap_get_account_tokens_balance),
        )
        .route(
          "/r/tap/getAccountTokenDetail/{address}/{ticker}",
          get(r::tap_get_account_token_detail),
        )
        // TAP transfer (initial transfer inscriptions)
        .route(
          "/r/tap/getInscribeTransferListLength/{tx}",
          get(r::tap_get_inscribe_transfer_list_length),
        )
        .route(
          "/r/tap/getInscribeTransferList/{tx}",
          get(r::tap_get_inscribe_transfer_list),
        )
        .route(
          "/r/tap/getTickerInscribeTransferListLength/{ticker}/{tx}",
          get(r::tap_get_ticker_inscribe_transfer_list_length),
        )
        .route(
          "/r/tap/getTickerInscribeTransferList/{ticker}/{tx}",
          get(r::tap_get_ticker_inscribe_transfer_list),
        )
        .route(
          "/r/tap/getInscribeTransferListByBlockLength/{block}",
          get(r::tap_get_inscribe_transfer_list_by_block_length),
        )
        .route(
          "/r/tap/getInscribeTransferListByBlock/{block}",
          get(r::tap_get_inscribe_transfer_list_by_block),
        )
        .route(
          "/r/tap/getTickerInscribeTransferListByBlockLength/{ticker}/{block}",
          get(r::tap_get_ticker_inscribe_transfer_list_by_block_length),
        )
        .route(
          "/r/tap/getTickerInscribeTransferListByBlock/{ticker}/{block}",
          get(r::tap_get_ticker_inscribe_transfer_list_by_block),
        )
        // TAP transfer (initial transfer flat/global and account scoped)
        .route(
          "/r/tap/getAccountTransferListLength/{address}/{ticker}",
          get(r::tap_get_account_transfer_list_length),
        )
        .route(
          "/r/tap/getAccountTransferList/{address}/{ticker}",
          get(r::tap_get_account_transfer_list),
        )
        .route(
          "/r/tap/getTickerTransferListLength/{ticker}",
          get(r::tap_get_ticker_transfer_list_length),
        )
        .route(
          "/r/tap/getTickerTransferList/{ticker}",
          get(r::tap_get_ticker_transfer_list),
        )
        .route(
          "/r/tap/getTransferListLength",
          get(r::tap_get_transfer_list_length),
        )
        .route(
          "/r/tap/getTransferList",
          get(r::tap_get_transfer_list),
        )
        // TAP transferred (executed transfers)
        .route(
          "/r/tap/getTransferredListLength/{tx}",
          get(r::tap_get_transferred_list_length),
        )
        .route(
          "/r/tap/getTransferredList/{tx}",
          get(r::tap_get_transferred_list),
        )
        .route(
          "/r/tap/getTickerTransferredListLength/{ticker}/{tx}",
          get(r::tap_get_ticker_transferred_list_length),
        )
        .route(
          "/r/tap/getTickerTransferredList/{ticker}/{tx}",
          get(r::tap_get_ticker_transferred_list),
        )
        .route(
          "/r/tap/getTransferredListByBlockLength/{block}",
          get(r::tap_get_transferred_list_by_block_length),
        )
        .route(
          "/r/tap/getTransferredListByBlock/{block}",
          get(r::tap_get_transferred_list_by_block),
        )
        .route(
          "/r/tap/getTickerTransferredListByBlockLength/{ticker}/{block}",
          get(r::tap_get_ticker_transferred_list_by_block_length),
        )
        .route(
          "/r/tap/getTickerTransferredListByBlock/{ticker}/{block}",
          get(r::tap_get_ticker_transferred_list_by_block),
        )
        // Sent/Receive (executed) account/ticker/global lists
        .route(
          "/r/tap/getAccountSentListLength/{address}/{ticker}",
          get(r::tap_get_account_sent_list_length),
        )
        .route(
          "/r/tap/getAccountSentList/{address}/{ticker}",
          get(r::tap_get_account_sent_list),
        )
        .route(
          "/r/tap/getTickerSentListLength/{ticker}",
          get(r::tap_get_ticker_sent_list_length),
        )
        .route(
          "/r/tap/getTickerSentList/{ticker}",
          get(r::tap_get_ticker_sent_list),
        )
        .route(
          "/r/tap/getSentListLength",
          get(r::tap_get_sent_list_length),
        )
        .route(
          "/r/tap/getSentList",
          get(r::tap_get_sent_list),
        )
        .route(
          "/r/tap/getAccountReceiveListLength/{address}/{ticker}",
          get(r::tap_get_account_receive_list_length),
        )
        .route(
          "/r/tap/getAccountReceiveList/{address}/{ticker}",
          get(r::tap_get_account_receive_list),
        )
        .route(
          "/r/tap/getTransferAmountByInscription/{inscription}",
          get(r::tap_get_single_transferable),
        )
        // Generic helpers
        .route(
          "/r/tap/getListRecords",
          get(r::tap_get_list_records),
        )
        .route(
          "/r/tap/getLength/{*length_key}",
          get(r::tap_get_length_generic),
        )
        // Node info
        .route(
